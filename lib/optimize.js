...
function buildOptimizePrompt(text, systemPrompt = SYSTEM_PROMPT) {
	return {
		model: MODEL,
		temperature: .3,
		stream: false,
...
//#endregion
export { BASE_URL, MAX_OUTPUT_TOKENS, MODEL, OptimizeError, SYSTEM_PROMPT, buildOptimizePrompt, callDeepSeekOptimize };
